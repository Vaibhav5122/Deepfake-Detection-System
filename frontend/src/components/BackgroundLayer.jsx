...
import cloudyIMG from "/assets/cloudy.mp4";

export const BackgroundLayer = ({ currentPath }) => {
  const [bgImage, setBgImage] = useState("/assets/cloudy.png");

  useEffect(() => {
    const backgrounds = {
      home: "/assets/cloudy.png",
  ...
  return (
    <div className="fixed inset-0 overflow-hidden -z-20">
      ...
      <div className="bg-video-container">
        ...
        <video className="bg-video" muted>
          {/* <source src="/assets/cloudy.mp4" type="video/mp4" /> */}
          <source src={cloudyIMG} type="video/mp4" />
        </video>
      </div>
